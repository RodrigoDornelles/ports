...
static const char k_mapping[] =
    DOPO_IPC_PAD_GUID_0 "," DOPO_IPC_PAD_NAME ","
    "a:b0,b:b1,x:b2,y:b3,"
...
static int pad_controller_button(uint8_t pad) {
    switch (pad) {
        case DOPO_IPC_PAD_A:    return SDL_CONTROLLER_BUTTON_A;
        case DOPO_IPC_PAD_B:    return SDL_CONTROLLER_BUTTON_B;
        case DOPO_IPC_PAD_C:    return SDL_CONTROLLER_BUTTON_X;
        case DOPO_IPC_PAD_D:    return SDL_CONTROLLER_BUTTON_Y;
        case DOPO_IPC_PAD_E:    return SDL_CONTROLLER_BUTTON_LEFTSHOULDER;
        case DOPO_IPC_PAD_F:    return SDL_CONTROLLER_BUTTON_RIGHTSHOULDER;
        case DOPO_IPC_PAD_MENU: return SDL_CONTROLLER_BUTTON_START;
        case DOPO_IPC_PAD_UP:   return SDL_CONTROLLER_BUTTON_DPAD_UP;
        case DOPO_IPC_PAD_DOWN: return SDL_CONTROLLER_BUTTON_DPAD_DOWN;
        case DOPO_IPC_PAD_LEFT: return SDL_CONTROLLER_BUTTON_DPAD_LEFT;
        case DOPO_IPC_PAD_RIGHT:return SDL_CONTROLLER_BUTTON_DPAD_RIGHT;
        default:                  return -1;
    }
}
...
const char *SDL_JoystickName(SDL_Joystick *joystick) {
    return pad_is_ours(joystick) ? DOPO_IPC_PAD_NAME : NULL;
}
...
SDL_JoystickGUID SDL_JoystickGetDeviceGUID(int device_index) {
    ...
    return SDL_JoystickGetGUIDFromString(DOPO_IPC_PAD_GUID_0);
}
...
char *SDL_GameControllerMappingForGUID(SDL_JoystickGUID guid) {
    SDL_JoystickGUID ours = SDL_JoystickGetGUIDFromString(DOPO_IPC_PAD_GUID_0);
    if (memcmp(&guid, &ours, sizeof(guid)) != 0) return NULL;
    return mapping_dup();
}

const char *SDL_GameControllerName(SDL_GameController *gamecontroller) {
    return pad_is_ours(gamecontroller) ? DOPO_IPC_PAD_NAME : NULL;
}

const char *SDL_GameControllerNameForIndex(int joystick_index) {
    return joystick_index == PAD_INDEX ? DOPO_IPC_PAD_NAME : NULL;
}
...
Uint8 SDL_GameControllerGetButton(SDL_GameController *gamecontroller, SDL_GameControllerButton button) {
    ...
    switch (button) {
        case SDL_CONTROLLER_BUTTON_A:             return s_pad.buttons[DOPO_IPC_PAD_A];
        case SDL_CONTROLLER_BUTTON_B:             return s_pad.buttons[DOPO_IPC_PAD_B];
        case SDL_CONTROLLER_BUTTON_X:             return s_pad.buttons[DOPO_IPC_PAD_C];
        case SDL_CONTROLLER_BUTTON_Y:             return s_pad.buttons[DOPO_IPC_PAD_D];
        case SDL_CONTROLLER_BUTTON_LEFTSHOULDER:  return s_pad.buttons[DOPO_IPC_PAD_E];
        case SDL_CONTROLLER_BUTTON_RIGHTSHOULDER: return s_pad.buttons[DOPO_IPC_PAD_F];
        case SDL_CONTROLLER_BUTTON_START:         return s_pad.buttons[DOPO_IPC_PAD_MENU];
